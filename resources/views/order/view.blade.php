                    ...
                    <form id="frm" method="post"  action ="{{route('order.update', $order[0]->order_id)}}"  class="form-horizontal form-label-left" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <table id="order" class="table table-bordered" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="ordertable">
                                        ...
                                        <td>
                                            <input type="text" id="qty" name="qty[]" class="form-control numberonly qty" value={{ $value->qty }} placeholder="Qty" readonly>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>Discount </td>
                                        <td><input type="text" id="discount" name="discount" class="form-control discount" placeholder="Discount" value="{{ $order[0]->discount }}" readonly></td>
                                    </tr>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea id="instruction" name="instruction" class="form-control" placeholder="Enter Instruction" readonly>{{$order[0]->instruction}}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="lr_no" name="lr_no" class="form-control" placeholder="Enter LR No" value="{{$order[0]->lr_no}}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="transporter" name="transporter" class="form-control" placeholder="Enter Transporter" value="{{$order[0]->transporter}}" readonly>
                                </div>
                            </div>
                        </div>
