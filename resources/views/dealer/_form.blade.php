      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            ...
            <div class="x_content">
              <br />
              <form id="frm" method="post"  action ="{{route('dealer.update', $dealer->id)}}"  class="form-horizontal form-label-left" autocomplete="off" enctype="multipart/form-data">
                @method('PUT')
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select class="select2_single form-control" name="city_id" id="city_id">
                      ...
                      <option value="{{$value->id}}" {{ ($value->id == $dealer->id) ? 'selected' : '' }}>{{$value->name}}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="name" name="name"  class="form-control col-md-7 col-xs-12 focusClass" placeholder="Enter Name" value="{{$dealer->name}}">
                  </div>
                </div>
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="radio">
                      <label style="margin-right:20px;">
                        <input type="radio" value="1" name="status" {{ ($dealer->status == 1) ? 'checked' : '' }}>Active
                      </label>
                      <label>
                        <input type="radio" value="0" name="status" {{ ($dealer->status == 0) ? 'checked' : '' }}>Deactive
                      </label>
                    </div>
                ...
                <div class="form-group">
                  <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                      <a href="{{route('dealer.index')}}" class="btn btn-primary">Cancel</a>
