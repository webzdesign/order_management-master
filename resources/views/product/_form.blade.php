				...
				<div class="x_content">
					<form id="frm" method="post"  action ="{{route('product.update', $product->id)}}"  class="form-horizontal form-label-left" autocomplete="off" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="name" class="form-control col-md-7 col-xs-12 focusClass" placeholder="{{ trans('product.placeholder.product_name') }}" value="{{ $product->name }}">
							</div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="op_stock" name="op_stock" class="form-control col-md-7 col-xs-12 numberonly" placeholder="{{ trans('product.placeholder.opening_stock') }}" value="{{$product->op_stock}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="price" name="price" class="form-control col-md-7 col-xs-12 numberonly" placeholder="{{ trans('product.placeholder.price') }}" value="{{$product->price}}">
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="radio">
                                    <label style="margin-right:4%;">
                                        <input type="radio" class="status" {{ ($product->status == 1) ? 'checked' : '' }} id="status" name="status" value="1">{{ trans('product.active')}}
                                    </label>
                                    <label style="margin-right:4%;">
                                        <input type="radio" class="status" {{ ($product->status == 0) ? 'checked' : '' }} id="status" name="status" value="0">{{ trans('product.deactive')}}
                                    </label>
                                </div>
						...
						<div class="form-group">
							<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
								...
								<button type="submit" class="btn btn-success focusClass">{{ trans('product.btn.Submit') }}</button>
							</div>
						</div>
